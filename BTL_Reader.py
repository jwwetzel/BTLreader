...
if args.channel is not None:
    ...
    allChanAx1.plot(x[args.start:args.end], y[args.start:args.end], marker=',', label="Channel "+str(chan),color=(redColor[int(chan)],greenColor[int(chan)],blueColor[int(chan)]))
